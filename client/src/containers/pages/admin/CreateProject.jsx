        ...
        if(status!=='default' && category !=='default' ){
            const fetchData = async()=>{
                ...
                try {
                    ...
                    const res = await axios.post(`${process.env.REACT_APP_API_URL}/api/portfolio/create_project`,
                    formData, 
                    config
                    )
    ...
    return (
        ...
        <div className="admin-container">
            ...
            <div className="author_blog">
                    <h2 className="heading">Crear proyecto</h2>
                    <form onSubmit={e=>onSubmit(e)} className="form-box" action="#" encType="multipart/form-data" >
                    {
                        ...
                        <div className="form-item">
                        {
                            ...
                            <>
                                <span>Vista previa
                                <img className="img-p" src={previewThumbnail}  alt="project img" /></span>
                            </>
                            :
                            <></>
                        }
