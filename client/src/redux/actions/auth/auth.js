import { ADD_MODAL, ADD_MSJ_MODAL, REMOVE_MODAL } from 'redux/actions/modal/types';
import {
    GET_LOGIN_SUCCESS,
    GET_LOGIN_FAIL,
...
export const reset_password = (email) => async dispatch => {
    ...
    try {
        const res = await axios.post(`${process.env.REACT_APP_API_URL}/api/user/send_reset_email/`, body, config);
...
export const reset_password_confirm = (uid, token, new_password, re_new_password) => async dispatch => {
    ...
    if (new_password !== re_new_password){
        ...
        try {
            const res = await axios.post(`${process.env.REACT_APP_API_URL}/api/user/reset_password_confirm/`, body, config);
